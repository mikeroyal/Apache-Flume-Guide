...
<img src="">
 ...
 Apache Flume Architecture. Source: [DataFlair](https://data-flair.training/blogs/flume-architecture/)

# Table of Contents

1. [Apache Flume Learning Resources](https://github.com/mikeroyal/Apache-Flume-Guide#Apache-Flume-learning-resources)

2. [Apache Flume Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Apache-Flume-Guide#Apache-Flume-tools-libraries-and-frameworks)

3. [Kubernetes](https://github.com/mikeroyal/Apache-Flume-Guide#kubernetes)

4. [Docker](https://github.com/mikeroyal/Apache-Flume-Guide#docker)

5. [Machine Learning](https://github.com/mikeroyal/Apache-Flume-Guide#machine-learning)

6. [Algorithms](https://github.com/mikeroyal/Apache-Flume-Guide#Algorithms)

7. [Deep Learning Development](https://github.com/mikeroyal/Apache-Flume-Guide#Deep-Learning-Development)

8. [Reinforcement Learning Development](https://github.com/mikeroyal/Apache-Flume-Guide#Reinforcement-Learning-Development)

9. [Computer Vision Development](https://github.com/mikeroyal/Apache-Flume-Guide#computer-vision-development)

10. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/Apache-Flume-Guide#nlp-development)

11. [Bioinformatics](https://github.com/mikeroyal/Apache-Flume-Guide#bioinformatics)

12. [Databases](https://github.com/mikeroyal/Apache-Flume-Guide#databases)

13. [CUDA Development](https://github.com/mikeroyal/Apache-Flume-Guide#cuda-development)

14. [MATLAB Development](https://github.com/mikeroyal/Apache-Flume-Guide#matlab-development)

15. [Java Development](https://github.com/mikeroyal/Apache-Flume-Guide#java-development)

16. [Clojure Development](https://github.com/mikeroyal/Apache-Flume-Guide#clojure-development)

17. [C/C++ Development](https://github.com/mikeroyal/Apache-Flume-Guide#cc-development)

18. [C# Development](https://github.com/mikeroyal/Apache-Flume-Guide#c-development)

19. [Python Development](https://github.com/mikeroyal/Apache-Flume-Guide#python-development)

20. [Go Development](https://github.com/mikeroyal/Apache-Flume-Guide#go-development)

21. [Scala Development](https://github.com/mikeroyal/Apache-Flume-Guide#scala-development)

22. [R Development](https://github.com/mikeroyal/Apache-Flume-Guide#r-development)


# Apache Flume Learning Resources
[Back to the Top](https://github.com/mikeroyal/Apache-Flume-Guide#table-of-contents)

[Apache Flume](https://flume.apache.org/) is a distributed, reliable, and available service for efficiently collecting, aggregating, and moving large amounts of streaming event data commonly using with [Apache Hadoop®](https://hadoop.apache.org/).

[Apache Flume Documentation](https://flume.apache.org/documentation.html)

[Apache Flume Tutorial – Flume Introduction, Features & Architecture | DataFlair](https://data-flair.training/blogs/apache-flume-tutorial/)

[Top Flume Courses Online | Udemy](https://www.udemy.com/topic/flume/)

[Master Big Data - Apache Spark/Hadoop/Sqoop/Hive/Flume Course | Udemy](https://www.udemy.com/course/big-data-ingestion-using-sqoop-and-flume-cca-and-hdpcd/)

[Apache Flume Course And Certification | SIIT | IT Training](https://siit.co/courses/apache-flume-course-and-certification/22)

[Apache Flume for Beginners | BigDataeLearning](https://bigdataelearning.com/course/apache-flume-for-beginners/)

[Apache Flume Training Courses | NobleProg](https://www.nobleprog.com/apache-flume-training)

[Apache Beam Documentation](https://beam.apache.org/documentation/)

[Apache Beam Developer Resources](https://beam.apache.org/documentation/resources/learning-resources/)

[Runners for Apache Beam](https://beam.apache.org/documentation/runners/capability-matrix/)
...
# Apache Flume Tools, Libraries, and Frameworks
[Back to the Top](https://github.com/mikeroyal/Apache-Flume-Guide#table-of-contents)
...
[Instaclustr Exporter](https://github.com/instaclustr/cassandra-exporter) is a Java agent that exports Cassandra metrics to Prometheus.
...
[Quill](https://github.com/getquill/quill) is a tool that provides a Quoted Domain Specific Language (QDSL) to express queries in Scala and execute them in a target language.
...
[Apache Camel](https://camel.apache.org/components/latest/cql-component.html) is an Open Source integration framework that empowers you to quickly and easily integrate various systems consuming or producing data.
...
[Presto](https://prestodb.io/docs/current/connector/cassandra.html) is an Cassandra connector allows querying data stored in Cassandra.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Apache-Flume-Guide/pulls).
